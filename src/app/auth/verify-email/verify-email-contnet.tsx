"use client";
// export const dynamic = "force-dynamic"; // This line is added to ensure that the API route is treated as dynamic and not cached by Next.js, which is important for authentication routes where we want to ensure that the latest data is always used and not served from cache.
